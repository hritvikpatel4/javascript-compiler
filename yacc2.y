...
TERNARY_EXPR
    : tk_opar COND{sprintf(block,"tern%d",bIndex++);strcpy(Quad[Index-1].block,block);push(block);flag1=0;} tk_cpar tk_tern ternary_statement {$$=buildTree("?",$2,$6);pop();}
    ;

ternary_statement
    : ASSIGN_EXPR tk_choice ASSIGN_EXPR {$$ = buildTree(":",$1,$3);flag1=1;}
    | EXP tk_choice EXP {$$ = buildTree(":",$1,$3);add_quadruple("=",$1->res,"","temp",0);add_quadruple("=",$3->res,"","temp",0);flag1=1;}
    | ASSIGN_EXPR tk_choice EXP {$$ = buildTree(":",$1,$3);add_quadruple("=",$3->res,"","temp",0);flag1=1;}
    | EXP tk_choice ASSIGN_EXPR {$$ = buildTree(":",$1,$3);add_quadruple("=",$1->res,"","temp",0);flag1=1;}
    ;
